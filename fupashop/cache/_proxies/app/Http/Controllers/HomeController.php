...
class HomeController extends HomeController__AopProxied implements \Go\Aop\Proxy
{
    ...
    {
        return self::$__joinPoints['method:index']->__invoke($this, [$request]);
    }
    
    
    public function myAccount()
    {
        return self::$__joinPoints['method:myAccount']->__invoke($this);
    }
...
\Go\Proxy\ClassProxy::injectJoinPoints('App\Http\Controllers\HomeController',array (
  'method' => 
  array (
    '__construct' => 
    array (
